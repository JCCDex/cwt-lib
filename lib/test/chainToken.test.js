...
const ethWallet = index_1.EthWallet.generate();
const rippleWallet_secp256k1 = index_1.RippleWallet.generate('secp256k1');
const rippleWallet_ed25519 = index_1.RippleWallet.generate('ed25519');
...
describe('quickSign and verify', () => {
    it('In Ethereum, fast cwt signature and verification', () => __awaiter(void 0, void 0, void 0, function* () {
        const ethCwt = index_1.ChainToken.quickSign(ethWallet.getPrivateKeyString(), "zhye", "ethereum", "secp256k1");
        expect(ethCwt).toBeTruthy();
        const chainToken = new index_1.ChainToken("ethereum", "secp256k1", ethWallet.getPublicKeyString(), "public");
    ...
    it('In ripple, fast cwt signature and verification', () => __awaiter(void 0, void 0, void 0, function* () {
        // ripple secp256k1
        const rippleCwt_secp256k1 = index_1.ChainToken.quickSign(rippleWallet_secp256k1.privateKey, "jc_ripple", "ripple", "secp256k1");
        expect(rippleCwt_secp256k1).toBeTruthy();
        const chainToken_secp256k1 = new index_1.ChainToken("ripple", "secp256k1", rippleWallet_secp256k1.publicKey, "public");
        const result_secp256k1 = chainToken_secp256k1.verify(rippleCwt_secp256k1);
        expect(result_secp256k1).toBe(true);
        // ripple ed25519
        const rippleCwt_ed25519 = index_1.ChainToken.quickSign(rippleWallet_ed25519.secret, "jc_ripple", "ripple", "ed25519");
        expect(rippleCwt_ed25519).toBeTruthy();
        const chainToken_ed25519 = new index_1.ChainToken("ripple", "ed25519", rippleWallet_ed25519.publicKey, "public");
    ...
    it("Error testing", () => __awaiter(void 0, void 0, void 0, function* () {
        expect(() => { index_1.ChainToken.quickSign(rippleWallet_ed25519.secret, "jc_ripple", "network", "ed25519"); })
...
describe('sign, decode and verify', () => {
    it('In Ethereum, cwt signature, decode and verification', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const privChainToken = new index_1.ChainToken("ethereum", "secp256k1", ethWallet.getPrivateKeyString(), "private");
        const cwt = privChainToken.sign(data);
        expect(cwt).toBeTruthy();
        expect(index_1.ChainToken.decode(cwt)).toBeTruthy();
    ...
    it('In Ripple, cwt signature, decode and verification', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // ripple secp256k1
        const privChainToken_secp256k1 = new index_1.ChainToken("ripple", "secp256k1", rippleWallet_secp256k1.secret, "secret");
        const cwt_secp256k1 = privChainToken_secp256k1.sign(data);
        expect(cwt_secp256k1).toBeTruthy();
        expect(index_1.ChainToken.decode(cwt_secp256k1)).toBeTruthy();
        const verify_secp256k1 = privChainToken_secp256k1.verify(cwt_secp256k1);
        expect(verify_secp256k1).toBe(true);
        // ripple ed25519
        const privChainToken_ed25519 = new index_1.ChainToken("ripple", "ed25519", rippleWallet_ed25519.secret, "secret");
        const cwt_ed25519 = privChainToken_ed25519.sign(data);
        expect(cwt_ed25519).toBeTruthy();
        expect(index_1.ChainToken.decode(cwt_ed25519)).toBeTruthy();

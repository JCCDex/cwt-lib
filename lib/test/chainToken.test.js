...
describe('quickSign and verify', () => {
    it('In Ethereum, fast cwt signature and verification', () => __awaiter(void 0, void 0, void 0, function* () {
        const ethCwt = index_1.ChainToken.quickSign(ethWallet.getPrivateKeyString(), "zhye", "ethereum");
        expect(ethCwt).toBeTruthy();
        const chainToken = new index_1.ChainToken("ethereum", ethWallet.getPublicKeyString(), "public");
    ...
    it('In ripple, fast cwt signature and verification', () => __awaiter(void 0, void 0, void 0, function* () {
        // ripple secp256k1
        const rippleCwt_secp256k1 = index_1.ChainToken.quickSign(rippleWallet_secp256k1.privateKey, "jc_ripple", "ripple");
        expect(rippleCwt_secp256k1).toBeTruthy();
        const chainToken_secp256k1 = new index_1.ChainToken("ripple", rippleWallet_secp256k1.publicKey, "public");
        const result_secp256k1 = chainToken_secp256k1.verify(rippleCwt_secp256k1);
        expect(result_secp256k1).toBe(true);
        // ripple ed25519
        const rippleCwt_ed25519 = index_1.ChainToken.quickSign(rippleWallet_ed25519.secret, "jc_ripple", "ripple");
        expect(rippleCwt_ed25519).toBeTruthy();
        const chainToken_ed25519 = new index_1.ChainToken("ripple", rippleWallet_ed25519.publicKey, "public");
    ...
    it("Error testing", () => __awaiter(void 0, void 0, void 0, function* () {
        expect(() => { index_1.ChainToken.quickSign(rippleWallet_ed25519.secret, "jc_ripple", "network"); })
...
describe('sign, decode and verify', () => {
    it('In Ethereum, cwt signature, decode and verification', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const privChainToken = new index_1.ChainToken("ethereum", ethWallet.getPrivateKeyString(), "private");
    ...
    it('In Ripple, cwt signature, decode and verification', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // ripple secp256k1
        const privChainToken_secp256k1 = new index_1.ChainToken("ripple", rippleWallet_secp256k1.secret, "secret");
        ...
        // ripple ed25519
        const privChainToken_ed25519 = new index_1.ChainToken("ripple", rippleWallet_ed25519.secret, "secret");
